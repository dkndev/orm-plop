...
module.exports = (context) => {
  ...
  return [
    ...
    {
      type: 'add',
      path: 'backend/api/app/{{pascalCase modelName}}.php',
    ...
    {
      type: 'add',
      path: `backend/api/database/migrations/${getMigrationTimestamp()}_create_{{snakeCase modelNamePlural}}_table.php`,
    ...
    {
      type: 'add',
      path: `backend/api/database/factories/{{pascalCase modelName}}Factory.php`,
    ...
    {
      type: 'add',
      path: `backend/api/app/Http/Routes/{{pascalCase modelName}}Routes.php`,
    ...
    {
      type: 'add',
      path: `backend/api/app/Http/Controllers/{{pascalCase modelName}}Controller.php`,
    ...
    {
      type: 'add',
      path: `backend/api/tests/Feature/API/{{pascalCase modelName}}Test.php`,
    ...
    {
      type: 'add',
      path: `backend/api/tests/Unit/{{pascalCase modelName}}Test.php`,
    ...
    {
      type: 'add',
      path: `backend/api/app/Policies/{{pascalCase modelName}}Policy.php`,
    ...
    {
      type: 'add',
      path: `backend/api/app/Observers/{{pascalCase modelName}}Observer.php`,
    ...
    {
      type: 'add',
      path: `backend/api/database/seeds/{{pascalCase modelName}}Seeder.php`,
    ...
    {
      type: 'add',
      path: `frontend/admin/src/store/classes/{{pascalCase modelName}}.js`,
    ...
    {
      type: 'add',
      path: `frontend/admin/src/components/Create{{pascalCase modelName}}Button.vue`,
    ...
    {
      type: 'add',
      path: `frontend/admin/src/components/Update{{pascalCase modelName}}Button.vue`,
    ...
    {
      type: 'add',
      path: `frontend/admin/src/components/{{pascalCase modelName}}Form.vue`,
    ...
    ...context.fields.map(field => {
      return {
        type: 'add',
        data: { field },
        path: `frontend/admin/src/components/{{pascalCase modelName}}${_.upperFirst(_.camelCase(field.name))}Input.vue`,
    ...
    {
      type: 'add',
      path: `frontend/app/src/store/classes/{{pascalCase modelName}}.js`,
      templateFile: 'plop/templates/ModelClass.js',
      skip() {
    ...
    {
      type: 'add',
      path: `frontend/app/src/components/Create{{pascalCase modelName}}Button.vue`,
      templateFile: 'plop/templates/CreateModelButton.vue',
      skip() {
    ...
    {
      type: 'add',
      path: `frontend/app/src/components/Update{{pascalCase modelName}}Button.vue`,
      templateFile: 'plop/templates/UpdateModelButton.vue',
      skip() {
    ...
    {
      type: 'add',
      path: `frontend/app/src/components/{{pascalCase modelName}}Form.vue`,
      templateFile: 'plop/templates/ModelForm.vue',
      skip() {
    ...
    ...context.fields.map(field => {
      return {
        type: 'add',
        data: { field },
        path: `frontend/app/src/components/{{pascalCase modelName}}${_.upperFirst(_.camelCase(field.name))}Input.vue`,
        templateFile: 'plop/templates/ModelFieldInput.vue',
        skip() {
    ...
    {
      type: 'append',
      path: 'backend/api/routes/api.php',
    ...
    {
      type: 'append',
      path: `frontend/admin/src/store/VuexORMClasses.js`,
    ...
    {
      type: 'append',
      path: `frontend/app/src/store/VuexORMClasses.js`,
      pattern: '\/\/ Import Classes',
      template: "import {{pascalCase modelName}} from 'classes/{{pascalCase modelName}}'",
      skip() {
        if(!context.clientFiles.includes('vuexOrmClass')) return 'not selected'
